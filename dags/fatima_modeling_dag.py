...
with DAG(
    ...
    "view_fact_orders": f"""
        ...
        SELECT DISTINCT o.order_id, o.customer_id, o.order_status, o.order_delivered_customer_date, o.order_estimated_delivery_date, p.payment_type, CASE WHEN p.payment_value < 0 THEN 0 ELSE p.payment_value END AS payment_value, r.review_score
    ...
    "view_dim_product": f"""
        ...
        SELECT DISTINCT oi.order_id, p.product_id, e.product_category_name, CASE WHEN p.product_weight_g < 0 THEN 0 ELSE p.product_weight_g END AS product_weight_g
